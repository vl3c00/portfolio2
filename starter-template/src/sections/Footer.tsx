  ...
  <footer className="bg-stone-900 text-white" id="contact">
    <div className="container">
      ...
      <div className="size-3 rounded-full bg-green-400 animate-pulse"></div>
         <span className="uppercase">Email for cybersecurity services</span>
         </div>
         <div className="grid md:grid-cols-3 md:items-center">
          <div className="md:col-span-2">
      <h2 className="text-4xl md:text-7xl lg:text-8xl mt-8 font-extralight" ref={scope}>
        Enough talk. Lets&apos;s make something great together.
        </h2>
      <Button 
        variant="secondary" 
        className="mt-8"
      ...
      <nav className="flex flex-col md:items-end gap-8 mt-16 md:mt-0">
        {navItems.map(({ href, label}) => (
          <a href={href} key={label} onClick={handleClickNavItem}>
            <Button variant="text" className="text-lg">{label}
      ...
      <p className="py-16 text-white/30 text-sm">Copyright &copy; Carlos Alec &bull; All rights reserved</p>
    </div>
  </footer>
