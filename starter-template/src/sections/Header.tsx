      ...
      <div className="fixed top-0 left-0 w-full h-0 overflow-hidden bg-stone-900 z-10" ref={navScope}>
        <nav className="mt-20 flex flex-col">
          {navItems.map(({label, href}) => (
             <a href={href} key={label} className="text-stone-200 last:border-b border-t border-stone-800 py-8 group/nav-item relative isolate"
            ...
            <div className="absolute w-full h-0 bg-stone-800 group-hover/nav-item:h-full translation-all duration-500 bottom-0 -z-10"></div>
            </a>
          ))}
        </nav>
      </div>
